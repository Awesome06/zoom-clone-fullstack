...
from app.schemas.meeting import (
    MeetingResponse, MeetingCreate, ScheduleMeetingRequest,
    InstantMeetingResponse, JoinMeetingRequest, JoinMeetingResponse
)
...
def get_recent_meetings(db: Session = Depends(get_db)):
    ...
    ).order_by(desc(Meeting.scheduled_start)).all()
    return meetings
